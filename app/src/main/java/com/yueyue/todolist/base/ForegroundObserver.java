...
/**
 * author : yueyue on 2018/3/2 01:04
 * desc   : 观察前台
 * quote  : wangchenyan/PonyMusic: https://github.com/wangchenyan/PonyMusic
 */
...
public class ForegroundObserver implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
        Log.e("activity:",activity.getClass().getSimpleName()+" onCreate----");
    }
    ...
    public void onActivityDestroyed(Activity activity) {
        Log.e("activity:",activity.getClass().getSimpleName()+" onDestroye----");
    }
